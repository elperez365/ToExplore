...
export function Login() {
    ...
    return (
        ...
        lg:bg-white">
            <div class="h-screen">
                <img src={prova2} alt="" class="hidden 
                md:hidden 
                lg:block lg:w-full lg:brightness-90 lg:h-full" />
                <h1 class="text-white text-center pt-2 font-bold
                md:text-[24px] md:font-bold
                lg:absolute lg:top-[12%] lg:right-[15%] lg:text-[50px] lg:font-extrabold lg:text-green-400 lg:z-10">ToExplore</h1>
                <h2 class="text-2xl font-extrabold w-52 m-auto mt-16 ml-[25%] 
                md:w-full md:m-auto md:text-center md:mt-[3%] md:text-[32px] 
                lg:absolute lg:top-[22%] lg:right-[16.2%] lg:m-auto lg:w-auto lg:text-[25px] lg:text-black lg:z-10">Life is a journey.</h2>
                <p class="text-xs w-80 m-auto ml-14 
                md:w-full md:m-auto md:text-center md:text-[16px] md:mt-[1%]
                lg:absolute lg:top-[26%] lg:right-[12.6%] lg:m-auto lg:w-auto lg:text-[15px] lg:text-black lg:z-10">Get ready to share your experiences with the world!</p>
                <div class="bg-white/90 w-80 h-64 m-auto mt-20 rounded-lg 
                ...
                lg:absolute lg:top-[0%] lg:right-[9%] lg:w-[25%] lg:h-[60%] lg:rounded-[20%] lg:opacity-95 lg:mt-[5%]">
                    ...
                    />
                    <button id="hideSvg" class="absolute right-[18%] top-[36.5%] 
                    md:absolute md:right-[23%] md:top-[29.5%] md:w-[80px] md:h-[40px]
                    lg:w-[70px] lg:h-[40px] lg:top-[44.5%] lg:right-[10%]" onClick={changeSvgIcon}>
                        <svg class="md:absolute md:right-[23%] md:top-[29.5%] md:w-[80px] md:h-[40px]
                        lg:w-[70px] lg:h-[40px] lg:z-10 lg:absolute lg:top-[44.5%] lg:right-[10%]" xmlns="http://www.w3.org/2000/svg" width="26" height="20" viewBox="0 0 24 24" fill="none">
                    ...
                    <button id="showSvg" class="absolute right-[18%] top-[36.5%] 
                    md:absolute md:right-[23%] md:top-[29.5%] md:w-[80px] md:h-[40px]
                    lg:w-[70px] lg:h-[40px] lg:top-[44.5%] lg:right-[10%]" onClick={changeSvgIcon}>
                        <svg class="md:absolute md:right-[23%] md:top-[29.5%] md:w-[80px] md:h-[40px]
                        lg:w-[70px] lg:h-[40px] lg:z-10 lg:absolute lg:top-[44.5%] lg:right-[10%]" xmlns="http://www.w3.org/2000/svg" width="26" height="20" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="flex items-center w-64 m-auto mt-5 text-xs 
                    ...
                    <Link to="/register">
                        <p class="text-xs w-64 m-auto mt-1 ml-[21%]
                        md:text-[20px] md:ml-0 md:absolute md:top-[50%] md:right-[30%] md:w-[38%] 
                        lg:absolute lg:m-auto lg:top-[84%] lg:right-[4.5%] lg:w-[85%] lg:h-[10%] lg:text-[25px]">Do not have an account? Sign in!</p>
                    </Link>
                </div>
                <img src={Travel} alt="" class="h-80 w-full m-auto mt-[44px] 
